...
- **posición en el pozo** (x_now, en sigmas) y la **fuerza cuántica** -dV/dx que
  empuja de vuelta al centro.
- **niveles de energía** E_n = omega (n + 1/2) del oscilador equivalente.

Referencias: Baaquie, "Quantum Finance" (2004); Choustova, "Bohmian mechanics for
financial processes" (2007); Ye & Huang (2008).
"""
...
if __name__ == "__main__":
    ...
    print(f"  posicion actual          : {res['x_now_sigma']:+.2f} sigma")
    print(f"  fuerza cuantica          : {res['fuerza_cuantica']:+.3f}")
